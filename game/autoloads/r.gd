...
const PRStartScreen := preload("res://game/rooms/start_screen/room_start_screen.gd")
# ---- classes
...
var StartScreen: PRStartScreen : get = get_StartScreen
# ---- nodes
...
func get_StartScreen() -> PRStartScreen: return get_runtime_room("StartScreen")
# ---- functions
