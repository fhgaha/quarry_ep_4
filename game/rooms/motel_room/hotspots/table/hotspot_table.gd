...
#	await C.player.say("What a nice view")
	...
	await C.player.say("Got you this newspaper, Spitz is swimming later")
	await C.player.say("I got you some potato skins")
	await C.player.say("Thats the best they have for breakfast")
	await C.player.say("Got some Niblets")
	await C.Joni.say("...")
